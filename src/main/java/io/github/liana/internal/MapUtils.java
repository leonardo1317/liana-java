...
public final class MapUtils {
     ...
     * <p>
     * The array must contain an even number of elements, where even-indexed elements
     * are keys and odd-indexed elements are their corresponding values.
     * <p>
     * For example, an array {@code ["key1", "value1", "key2", "value2"]} will be converted
     * into a map with two entries: "key1" -> "value1" and "key2" -> "value2".
     *
     ...
     * @throws IllegalArgumentException if {@code entries} has an odd length (i.e., a key without a corresponding value)
     */
