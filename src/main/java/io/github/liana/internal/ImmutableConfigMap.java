 ...
 * <p>
 * This class wraps a {@link Map} and ensures that its content cannot be modified
 * after creation. Keys and values are strings, and access is restricted through
 * a controlled API that validates non-null keys.
 * <p>
...
public class ImmutableConfigMap {
    ...
    /**
     * Creates a new immutable configuration map from the given map.
     * The internal representation is unmodifiable.
     *
    ...
    /**
     * Creates an immutable configuration map using the provided key-value pairs.
     * Keys are inserted in the order defined by {@link LinkedConfigMap}.
     *
    ...
    /**
     * Retrieves the value associated with the given key, or returns the default value if the key is not present.
     *
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof ImmutableConfigMap)) return false;
