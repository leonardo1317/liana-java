...
public class LinkedConfigSet extends LinkedHashSet<String> {
  ...
  /**
   * Constructs an empty {@code LinkedConfigSet}, using default validation rules. Keys and values
   * must be non-blank.
   */
  ...
  /**
   * Constructs a {@code LinkedConfigSet} from the given collection. All blank or null values are
   * ignored.
   *
