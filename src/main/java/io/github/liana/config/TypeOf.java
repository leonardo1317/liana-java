 ...
 * <p>
 * This abstract class allows retrieval of the generic type parameter {@code T}
 * by subclassing via anonymous class instantiation. This approach overcomes
 * Java's type erasure limitation at runtime.
 * </p>
 *
 * <pre>{@code
...
public abstract class TypeOf<T> {
     ...
     * <p>
     * This constructor must be invoked via an anonymous class to properly capture
     * the type parameter. Direct subclassing without specifying the generic type
     * will result in an exception.
     * </p>
     *
     * @throws IllegalArgumentException if the class is not properly parameterized
     *                                  as an anonymous class with a concrete type.
