...
class ConsoleConfigLoggerTest {

  @Test
  @DisplayName("should return non-null logger instances")
  void shouldReturnNonNullLoggerInstances() {
    ConfigLogger defaultLogger = ConsoleConfigLogger.getLogger();
    ConfigLogger verboseLogger = ConsoleConfigLogger.getLogger(true);
  ...
  void shouldLogDebugMessageWhenLevelEnabled() {
    ...
    ConfigLogger logger = ConsoleConfigLogger.getLogger(true);
  ...
  void shouldNotLogDebugMessageWhenLevelDisabled() {
    ...
    ConfigLogger logger = ConsoleConfigLogger.getLogger(false);
    logger.debug(() -> "debug message");
  ...
  void shouldLogWarnMessageWhenDefaultLevel() {
    ...
    ConfigLogger logger = ConsoleConfigLogger.getLogger();
    logger.warn(() -> "warn message");
