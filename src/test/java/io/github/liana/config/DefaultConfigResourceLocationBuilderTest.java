...
class DefaultConfigResourceLocationBuilderTest {

  private DefaultConfigResourceLocationBuilder builder;

  @BeforeEach
  void setUp() {
    builder = new DefaultConfigResourceLocationBuilder();
  }

  @Test
  @DisplayName("should set provider and return same builder instance")
  void shouldSetProviderAndReturnSameBuilder() {
    ConfigResourceLocationBuilder returned = builder.provider("classpath");
  ...
  void shouldAddMultipleBaseDirectoriesArray() {
    ConfigResourceLocationBuilder returned = builder.baseDirectories("config", "app");
  ...
  void shouldAddSingleResourceAndReturnSameBuilder() {
    ConfigResourceLocationBuilder returned = builder.addResource("app.yaml");
  ...
  void shouldAddMultipleResourcesFromArray() {
    ConfigResourceLocationBuilder returned = builder.addResources("a.yaml", "b.json");
  ...
  void shouldAddResourcesFromList() {
    ConfigResourceLocationBuilder returned = builder.addResourceFromList(
  ...
  void shouldAddVariableKeyValuePair() {
    ConfigResourceLocationBuilder returned = builder.addVariable("env", "prod");
  ...
  void shouldWrapIllegalArgumentExceptionWhenVariableKeyIsInvalid() {
    ...
    assertThrows(InvalidConfigVariablesException.class,
  ...
  void shouldAddVariablesFromVarargs() {
    ConfigResourceLocationBuilder returned = builder.addVariables("env", "test", "region", "us");
  ...
  void shouldWrapIllegalArgumentExceptionWhenVariablesKeyIsInvalid() {
    assertThrows(InvalidConfigVariablesException.class, () -> builder.addVariables("", "staging"));
  }

  @Test
  @DisplayName("should throw InvalidConfigVariablesException when map contains invalid key")
  ...
  void shouldAddVariablesFromMap() {
    ...
    ConfigResourceLocationBuilder returned = builder.addVariablesFromMap(map);
  ...
  void shouldEnableVerboseLoggingAndReturnSameBuilder() {
    ConfigResourceLocationBuilder returned = builder.verboseLogging(true);
  ...
  void shouldSetPlaceholderAndReturnSameBuilder() {
    ...
    ConfigResourceLocationBuilder returned = builder.placeholders(placeholder);
  ...
  @Test
  @DisplayName("should build DefaultConfigResourceLocation with default values when none set")
  void shouldBuildWithDefaultValuesWhenNoneSet() {
    ConfigResourceLocation result = builder.build();

    assertNotNull(result);
  }

  @Test
  @DisplayName("should build DefaultConfigResourceLocation with provided parameters")
